...
#Setup logging
logging.basicConfig(format='%(asctime)s %(message)s',filename=r'c:\python34\fcsr_agilent\fcsr_agilent.log',level=logging.DEBUG)
logging.info('Program started.')

#Ini-File Öffnen
configparser = configparser.RawConfigParser()
configFilePath = r'c:\python34\fcsr_agilent\fcsr_agilent.ini' #die .ini soll im selben Ordner liegen wie fcsr_agilent.py
...
with open(r'c:\python34\fcsr_agilent\processed_folders.txt', 'r') as procFolders:
        ...
        if file.lower().endswith("dad1.uv"):
            ...
            if level <= searchDepth:
                if tops in procFoldersList:
                    ...
                    with open(r'c:\python34\fcsr_agilent\processed_folders.txt', 'a') as procFolders:
